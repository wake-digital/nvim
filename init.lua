...
vim.keymap.set('n', '<leader>n', '<cmd>Explore<CR>', { desc = 'Open Netrw file explorer' })
...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      vim.keymap.set("n", "<leader>e", require("harpoon.ui").toggle_quick_menu, { desc = "[e]xplore harpoon files" })
    ...
    config = function()
      ...
      vim.diagnostic.config {
        ...
        float = {
          ...
          focusable = false,  -- Don't steal cursor focus
          header = "",        -- No header
          prefix = "",        -- No prefix
        },
        -- severity_sort = true,
      ...
      local servers = {
        ...
        --[[ liquid_lsp = {
          cmd = { "liquid_lsp", "--stdio" },
          filetypes = { "liquid", "liquid-css", "liquid-scss", "liquid-js" },
          root_markers = { ".git" },
          settings = {},
        } ]]
      }
